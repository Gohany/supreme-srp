...
module.exports = (function () {
        ...
        SRPClient = function (username, password, group, hashFn) {
                ...
                this.hashFn = hashFn || 'sha-256';
                // Store username/password.
                this.username = username;
                this.preHashPassword = password;
                this.serverScriptSalt = 'y=hDTFBWzid_W_r_(@(vL}>lQ+hQ]JdLyZTIh%27l9<^Qht*QuD(uHz6WgtK9!Ls';
        ...
        SRPClient.prototype = {
                ...
                start: function ()
                {
                        ...
                        var req = http.request(options, function (res) {
                                ...
                                res.on('data', function (chunk) {
                                        ...
                                        self.calculateV(salt);
                                        var B = new BigInteger(_response1['body'].srp.B, 16);
                                        var u = self.calculateU(A, B);
                ...
                setPasswordHash: function (salt)
                {
                        this.password = this.hash(this.serverScriptSalt + this.preHashPassword + salt);
                },
                /*
                 ...
                 */
                k: function () {
                        var k = new BigInteger(this.hexHash(this.N.toString(16) + this.str_pad(this.g.toString(16), 512, '0', 'STR_PAD_LEFT')), 16);
                        return k;
                },
                /*
                ...
                calculateX: function (saltHex) {
                        ...
                        var X = new BigInteger(this.hexHash(this.str_pad(saltHex, 512, '0', 'STR_PAD_LEFT') + usernamePasswordHash), 16).mod(this.N);
                ...
                calculateU: function (A, B) {
                        ...
                        var toHash = [this.str_pad(A.toString(16), 512, '0', 'STR_PAD_LEFT'), this.str_pad(B.toString(16), 512, '0', 'STR_PAD_LEFT')];
                ...
                /*
                 * Cacluate client match M_c = H(H(N) ^ H(g), H(I), s, A, B, K_c)
                 */
                calculateM_c: function (s, A, B, K_c)
                {
                        if (!s || !A || !B || !K_c)
                        {
                                throw 'Missing parameter(s).';
                        ...
                        var hashN = this.hexHash(this.str_pad(this.N.toString(16), 512, '0', 'STR_PAD_LEFT'));
                        var hashG = this.hexHash(this.str_pad(this.g.toString(16), 512, '0', 'STR_PAD_LEFT'));
                        var hashGB = new BigInteger(hashG, 16);
                        var hashNB = new BigInteger(hashN, 16);

                        //var array = [hashN.xor(hashG), this.paddedHash(this.username), s.toString(16), A.toString(16), B.toString(16), K.toString(16)];
                        return this.hexHash(hashNB.xor(hashGB).toString(16) + this.hash(this.username) + this.str_pad(s.toString(16), 512, '0', 'STR_PAD_LEFT') + this.str_pad(A.toString(16), 512, '0', 'STR_PAD_LEFT') + this.str_pad(B.toString(16), 512, '0', 'STR_PAD_LEFT') + K_c);

                },
                /*
                 * Calculate server match M = H(A, B, K) or M = H(A, M, K)
                 */
                ...
                calculateS: function (B, salt, uu, aa) {
                        ...
                        var btmp2 = btmp.modPow(x.multiply(uu).add(aa), this.N);

                        return this.hexHash(this.str_pad(btmp2.toString(16), 512, '0', 'STR_PAD_LEFT'));
                ...
                initVals: {
                        1024: {
                                N: '',
                                g: '2'
